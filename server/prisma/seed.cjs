...
const categories = [
  ...
  { id: "cat-coal", name: "Вугілля", slug: "coal" },
  { id: "cat-disposables", name: "Одноразові електронні сигарети", slug: "disposables" },
  { id: "cat-snus", name: "Снюс", slug: "snus" },
  { id: "cat-hookah-accessories", name: "Аксесуари для кальянів", slug: "hookah-accessories" },
  { id: "cat-pod-systems", name: "Pod-системи", slug: "pod-systems" },
  { id: "cat-cartridges-coils", name: "Картриджі та випаровувачі", slug: "cartridges-coils" },
  { id: "cat-liquids", name: "Рідини", slug: "liquids" },
];
...
const products = [
  ...
  },
  {
    ...
    description: "Тютюн Space Tea 100 г. — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Підсилювач смаку Space Tea Boost Skittles (Скіттлс) 15 мл.webp",
  },
  {
    id: "prod-v2-tiutiun-space-tea-40-h",
    categoryId: "cat-tobacco",
    name: "Тютюн Space Tea 40 г.",
    description: "Тютюн Space Tea 40 г. — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Підсилювач смаку Space Tea Boost Skittles (Скіттлс) 15 мл.webp",
  },
  {
    ...
    description: "Тютюн Mint (безтютюнова суміш) 50 грам — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Тютюн Lirra Mint (М'ята) 50 гр.webp",
  },
  {
    id: "prod-v2-tiutiun-heven-100h",
    categoryId: "cat-tobacco",
    name: "Тютюн Heven 100г",
    description: "Тютюн Heven 100г — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Тютюн Enigma x Heven Cosmo Shadow (Космо Шедоу) 100 гр.webp",
  },
  {
    id: "prod-v2-tiutiun-pixtea-100-hram",
    categoryId: "cat-tobacco",
    name: "Тютюн Pixtea 100 грам",
    description: "Тютюн Pixtea 100 грам — Тютюн для кальяну.",
    priceCents: 30000,
  ...
  },
  {
    ...
    description: "Тютюн Pixtea 50 грам — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=tiutiun-pixtea-50-hram",
  },
  {
    id: "prod-v2-tiutiun-unity-100h",
    categoryId: "cat-tobacco",
    name: "Тютюн Unity 100г",
    description: "Тютюн Unity 100г — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Тютюн Unity x Lebiga Cristmas Vibe (Крістмас Вайб) 100 гр.webp",
  },
  {
    id: "prod-v2-tiutiun-4-20-clasic-ta-frost-line-100h",
    categoryId: "cat-tobacco",
    name: "Тютюн 4.20 Clasic та Frost Line 100г.",
    description: "Тютюн 4.20 Clasic та Frost Line 100г. — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Тютюн 420 Classic Frost Line Waterberry Shot (Вотерберрі Шот) 100 гр.webp",
  },
  {
    id: "prod-v2-tiutiun-4-20-light-100h",
    categoryId: "cat-tobacco",
    name: "Тютюн 4.20 Light 100г",
    description: "Тютюн 4.20 Light 100г — Тютюн для кальяну.",
    priceCents: 30000,
    imageUrl: "/images/products/Тютюн 420 Light Line Кавун Лимон 100 гр.webp",
  },
  {
  ...
  },
  {
    ...
    priceCents: 18000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=oxva-xlim-v2",
  },
  {
  ...
  },
  {
    ...
    priceCents: 18000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=smok-novo-4-mini-empty-porozhnii",
  },
  {
  ...
  },
  {
    ...
    priceCents: 18000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=smok-nord-2-rpm-empty-porozhnii",
  },
  {
  ...
  },
  {
    ...
    priceCents: 19000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=ridyny-lucky-chrome-30-ml",
    isAvailable: false,
  },
  {
  ...
  },
  {
    ...
    description: "фото відсутні — смаки не підтверджено фотографіями, потрібне фото від постачальника",
    priceCents: 19000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=ridyny-sour-boom-30ml-zamis",
    isAvailable: false,
  },
  {
    ...
    description: "фото відсутні — смаки не підтверджено фотографіями, потрібне фото від постачальника",
    priceCents: 14000,
    imageUrl: "https://placehold.co/800x800/1e3a5f/eee?text=ridyny-sour-boom-15ml",
    isAvailable: false,
  },
  {
...
const productVariants = [
  ...
  },
  {
    ...
    tastes: [
      { name: "Вишня Ментол", imageUrl: "/images/products/Рідина Chaser For Pods Вишня Ментол 10 мл.webp" },
      ...
      { name: "Ягоди", imageUrl: "/images/products/Рідина Chaser For Pods Ягоди 10 мл.webp" },
    ],
    sizes: [{ size: null, priceCents: 12000 }],
  },
  {
    ...
    tastes: [
      ...
      { name: "Кавун Ментол", imageUrl: "/images/products/Рідина Chaser For Pods Кавун Ментол 30 мл.webp" },
      { name: "Яблуко", imageUrl: "/images/products/Рідина Chaser For Pods Яблуко 30 мл.webp" },
      { name: "Ягоди", imageUrl: "/images/products/Рідина Chaser For Pods Ягоди 30 мл.webp" },
    ],
    sizes: [{ size: null, priceCents: 19000 }],
  },
  {
  ...
  },
  {
    ...
    tastes: [
      ...
      { name: "Малина Ревінь", imageUrl: "/images/products/Набір Chaser Mix 30 мл 50 мг - Малина Ревінь.webp" },
      { name: "Полуниця Квас", imageUrl: "/images/products/Набір Chaser Mix 30 мл 50 мг - Полуниця Квас.webp" },
      { name: "Вишня Кавун", imageUrl: "/images/products/Набір Chaser Mix 30 мл 65 мг - Вишня Кавун.webp" },
  ...
  },
  {
    ...
    tastes: [
      { name: "Blue Raspberry", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Blue Raspberry.webp" },
      { name: "Fresh Mint", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Fresh Mint.webp" },
      { name: "Kiwi Passion Guava", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Kiwi Passion Guava.webp" },
      { name: "Lemon Lime", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Lemon Lime.webp" },
      { name: "Orange Pineapple", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Orange Pineapple.webp" },
      ...
      { name: "Watermelon Ice", imageUrl: "/images/products/Набір Dinner Lady Fruit Full 30 мл 30 50 мг - Watermelon Ice.webp" },
    ],
    sizes: [{ size: null, priceCents: 19000 }],
  },
  {
