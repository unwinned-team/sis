...
const productVariants = [
  // ── Liquids ──
  {
    ...
    descriptions: {
      "Крижана м'ята":
        "Удар холоду з першої затяжки: на вдиху — різкий крижаний фреш, на видиху — солодкувата м'ята, що довго тримається на язиці. Відчувається як ковток крижаної води у спеку — бадьорить і перезавантажує рецептори.",
      "Ментол":
        "Чистий ментол без солодкості та домішок: суха дзвінка свіжість, що пронизує від горла до кінчика язика. Для тих, хто любить максимально різку, чесну прохолоду без фруктових прикрас.",
      "М'ята-лайм":
        "Свіжа м'ята, підкреслена соковитою кислинкою лайма: на вдиху — цитрус, на видиху — прохолодний м'ятний шлейф. Збалансований легкий смак, який не набридає навіть за цілий день.",
    },
  },
  {
    ...
    descriptions: {
      "Полуниця":
        "Стигла червнева полуниця, розтерта з цукром: густа джемова солодкість із теплою карамельною ноткою на видиху. М'який обволікаючий смак без різкості — десерт на щодень.",
      "Кавун":
        "Соковита кавунова м'якоть із ледь помітним холодком: легкий, водянисто-свіжий профіль, що не переслоджує. П'ється як літній лимонад і чудово освіжає.",
      "Манго-маракуйя":
        "Тропічний дует: солодке волокнисте манго на вдиху та яскрава кислинка маракуйї на видиху. Насичений екзотичний смак із довгим фруктовим післясмаком.",
    },
  },
  {
    ...
    descriptions: {
      "Енергетик":
        "Холодний класичний енергетик: терпка тонізуюча солодкість, газоване поколювання на язиці та льодяний фініш. Упізнаваний смак «з банки», що бадьорить з першої затяжки.",
      "Кола-лимон":
        "Газована кола зі скибкою лимона: карамельна солодкість напою та цитрусова свіжість на видиху. Грайливий шипучий смак із приємною кислинкою.",
      "Жуйка":
        "Солодка фруктова жуйка з дитинства: рожевий бабл-гам із ягідними нотками та м'яким ванільним шлейфом. Простий безтурботний смак, що довго тримається.",
    },
  },
  {
    ...
    descriptions: {
      "Чорниця":
        "Ніжна лісова чорниця: округла ягідна солодкість без кислоти, з м'яким джемовим післясмаком. Спокійний обволікаючий смак — саме те на вечір.",
      "Чорниця-лайм":
        "Солодка чорниця, розбуджена різкою кислинкою лайма: ягода на вдиху, цитрус на видиху. Контрастний свіжий профіль, що бадьорить і не приторить.",
      "Чорниця-малина":
        "Глибока чорниця та яскрава садова малина в одному міксі: соковито, злегка терпко, з довгим солодким ягідним шлейфом.",
    },
  },
  {
    ...
    descriptions: {
      "Манго":
        "Стигле тропічне манго: густа медова солодкість і соковита волокниста м'якоть у кожній затяжці. Теплий обволікаючий смак, що переносить на пляж.",
      "Манго-персик":
        "Манго з ніжною персиковою м'якоттю: оксамитова солодкість без кислоти, м'який кремовий видих. Делікатний фруктовий профіль для розміреного парування.",
      "Манго-маракуйя":
        "Солодке манго та зухвала кислинка маракуйї: яскравий контраст на вдиху й видиху. Освіжаючий тропічний мікс, що не дає рецепторам занудьгувати.",
    },
  },
  {
    ...
    descriptions: {
      "Виноград":
        "Насичений темний виноград: глибока винна солодкість із легкою терпкістю шкірки. Багатий дорослий смак із довгим післясмаком.",
      "Виноград-яблуко":
        "Солодкий виноград і хрустке зелене яблуко: соковитий дует із свіжою кислинкою на видиху. Легкий фруктовий профіль на щодень.",
      "Виноград-кавун":
        "Виноградна солодкість, розбавлена водянистою свіжістю кавуна: легкий літній мікс, що освіжає й не набридає.",
    },
  },
  {
    ...
    descriptions: {
      "Кавун":
        "Класичний стиглий кавун: легка водяниста солодкість і відчуття скибки просто з холодильника. Чистий освіжаючий смак без зайвого.",
      "Кавун-димчастий":
        "Кавун із пікантним димчастим післясмаком: солодка м'якоть на вдиху та несподівана «копчена» нота на видиху. Незвичний профіль для тих, хто втомився від класики.",
      "Кавун-полуниця":
        "Соковитий кавун і стигла полуниця: подвійна літня солодкість зі свіжим ягідним фінішем. М'який сонячний смак без кислоти.",
    },
  },
  {
    ...
    descriptions: {
      "Тютюн класичний":
        "Чистий тютюновий лист із сухими деревними нотами: щільний, злегка пряний смак із впізнаваною гірчинкою на видиху. Для прихильників класики без солодощів.",
      "Тютюн-горіх":
        "Тютюн, зігрітий смаженим горіхом: теплі ноти праліне пом'якшують гірчинку листа. Затишний «трубковий» профіль на вечір.",
      "Тютюн-карамель":
        "Тютюновий лист під вершковою карамеллю: солодкий десертний вдих і суха тютюнова гірчинка на видиху. Збалансований смак між класикою та десертом.",
    },
  },
  {
    ...
    descriptions: {
      "Полуниця":
        "Стигла літня полуниця в чистому вигляді: соковита ягідна солодкість із легким ароматом вершків. Простий і безпрограшний смак на щодень.",
      "Полуниця-ківі":
        "Солодка полуниця з терпкою свіжістю ківі: ягода на вдиху, зелена кислинка на видиху. Яскравий тонізуючий мікс.",
      "Полуниця-лайм":
        "Полуниця, збризнута соком лайма: солодкість і цитрусова різкість в ідеальному балансі. Освіжає та тримає рецептори в тонусі.",
    },
  },
  {
    ...
    descriptions: {
      "Лимон":
        "Яскравий кислий лимон: дзвінка цитрусова свіжість із легкою гірчинкою цедри. Максимально бадьорий смак — прокидаєшся з першої затяжки.",
      "Лимон-безe": "Лимонний курд під шапкою повітряного безе: вершкова солодкість згладжує цитрусову кислоту. Справжній десертний тарт — без жодної калорії.",
      "Лимон-лайм":
        "Подвійний цитрус: кислий лимон і терпкий лайм в одній затяжці. Різкий, максимально свіжий профіль для любителів кислинки.",
    },
  },
  {
    ...
    descriptions: {
      "Ананас":
        "Соковитий стиглий ананас: яскрава тропічна солодкість із пікантною кислинкою на видиху. Сонячний смак, що освіжає та бадьорить.",
      "Ананас-кокос":
        "Піна-колада без рому: солодкий ананас і вершковий кокос у м'якому кремовому міксі. Оксамитовий видих із відчуттям відпустки.",
      "Ананас-манго":
        "Ананасова кислинка та медова м'якоть манго: подвійний тропічний удар. Насичений солодкий профіль із довгим екзотичним післясмаком.",
    },
  },
  {
    ...
    descriptions: {
      "Ваніль":
        "Ніжний вершковий крем із натуральною ваніллю: м'яка обволікаюча солодкість без різкості. Теплий затишний смак — як ванільний пудинг.",
      "Ваніль-карамель":
        "Ваніль із тягучою солоною карамеллю: густий десертний профіль із маслянистим видихом. Для солодкоїжок, які люблять багатий смак.",
      "Ваніль-кокос":
        "Ванільний крем із кокосовою стружкою: екзотична ніжність із легким горіховим відтінком. М'який тропічний десерт у кожній затяжці.",
    },
  },
  ...
  // ── Nic Salts ──
  {
    ...
    descriptions: {
      "Манго":
        "Насичене стигле манго на сольовому нікотині: густа тропічна солодкість і м'яка подача без удару по горлу. Швидке насичення — ідеально для компактних pod-систем.",
      "Манго-маракуйя":
        "Солодке манго з яскравою кислинкою маракуйї: контрастний тропічний мікс із рівною сольовою подачею. Освіжає й не дере горло навіть на високій міцності.",
      "Манго-персик":
        "Манго та соковитий персик: оксамитова подвійна солодкість із кремовим видихом. М'який профіль без кислоти — комфортний на весь день.",
    },
  },
  {
    ...
    descriptions: {
      "М'ята":
        "Холодна м'ята на сольовій основі: чиста свіжість із м'якою подачею нікотину. Освіжає як льодяник — без різкості по горлу.",
      "М'ята-лайм":
        "Прохолодна м'ята із цитрусовою кислинкою лайма: подвійна свіжість на вдиху та видиху. Бадьорий смак, що швидко знімає бажання курити.",
      "М'ята-виноград":
        "Солодкий виноград під м'ятним холодком: ягідна глибина та свіжий фініш. Збалансований мікс для щоденного парування.",
    },
  },
  {
    ...
    descriptions: {
      "Лічі":
        "Екзотичне лічі: ніжна квіткова солодкість із прохолодним соковитим видихом. Делікатний смак, який не зустрінеш на кожному кроці.",
      "Лічі-малина":
        "Лічі з солодкою садовою малиною: квітково-ягідний дует із м'якою сольовою подачею. Ніжний, ледь парфумований профіль.",
      "Лічі-лайм":
        "Лічі з терпкою свіжістю лайма: солодка екзотика та цитрусова кислинка в балансі. Освіжаючий смак на спеку.",
    },
  },
  {
    ...
    descriptions: {
      "Виноград":
        "Соковитий темний виноград: глибока винна солодкість із м'якою подачею сольового нікотину. Насичений смак без терпкості по горлу.",
      "Виноград-м'ята":
        "Виноград із прохолодним м'ятним фінішем: солодкий вдих і свіжий холодний видих. Класичний дует, що ніколи не набридає.",
      "Виноград-яблуко":
        "Виноград і соковите зелене яблуко: подвійна фруктова свіжість із легкою кислинкою. Легкий смак на весь день.",
    },
  },
  {
    ...
    descriptions: {
      "Полуниця":
        "Стигла літня полуниця: соковита ягідна солодкість і м'яка сольова подача без подразнення горла. Простий улюблений смак у зручному форматі.",
      "Полуниця-лайм":
        "Полуниця з бадьорою кислинкою лайма: солодка ягода на вдиху, цитрусова свіжість на видиху. Тонізуючий контрастний мікс.",
      "Полуниця-кавун":
        "Полуниця та соковитий кавун: подвійна літня солодкість із водянистою свіжістю. Легкий сонячний профіль без приторності.",
    },
  },
  {
    ...
    descriptions: {
      "Чорниця":
        "Насичена лісова чорниця: глибока ягідна солодкість із легкою терпкістю. М'яка сольова подача — комфортно навіть на 35 мг.",
      "Чорниця-малина":
        "Чорниця із солодкою садовою малиною: соковитий ягідний джем у паровому форматі. Округлий смак із довгим післясмаком.",
      "Чорниця-гранат":
        "Чорниця з терпкими нотами стиглого граната: багатий ягідний профіль із винною глибиною. Дорослий, нетривіальний смак.",
    },
  },
  {
    ...
    descriptions: {
      "Кавун":
        "Свіжий соковитий кавун: легка водяниста солодкість, наче скибка просто з холодильника. М'яка подача та швидке насичення.",
      "Кавун-димчастий":
        "Кавун із легким димчастим відтінком: солодка м'якоть і несподівана копчена нота на видиху. Для тих, хто шукає щось нове.",
      "Кавун-полуниця":
        "Кавун із солодкою стиглою полуницею: подвійний літній мікс, соковитий та освіжаючий. Без кислоти й зайвого холоду.",
    },
  },
  {
    ...
    descriptions: {
      "Персик":
        "Соковитий персик із ніжною медовою солодкістю: оксамитова м'якоть у кожній затяжці. М'яка сольова подача — жодного удару по горлу.",
      "Персик-абрикос":
        "Персик із медовим абрикосом: тепла південна солодкість із кремовим видихом. Затишний фруктовий профіль без кислинки.",
      "Персик-маракуйя":
        "Ніжний персик та екзотична кислинка маракуйї: солодкість і свіжість у рівновазі. Яскравий смак, що бадьорить.",
    },
  },
  {
    ...
    descriptions: {
      "Ментол":
        "Чистий крижаний ментол: пронизлива свіжість від горла до легень, максимальний холод без солодкості. На 50 мг — швидке та потужне насичення.",
      "Ментол-лайм":
        "Крижаний ментол із цитрусовою кислинкою лайма: подвійний фреш, що миттєво перезавантажує рецептори. Різко, холодно, бадьоро.",
      "Ментол-евкаліпт":
        "Ментол із трав'яною свіжістю евкаліпта: прохолода з легким аптечним відтінком, що очищає дихання. Незвичний смак для поціновувачів холоду.",
    },
  },
  {
    ...
    descriptions: {
      "Тютюн":
        "Класичний тютюновий смак на сольовій основі: сухий лист із деревними нотами та м'якою подачею. Найближче до звичної сигарети — для плавного переходу.",
      "Тютюн-горіх":
        "Тютюн із теплими горіховими нотами: смажене праліне пом'якшує гірчинку листа. Затишний вечірній профіль.",
      "Тютюн-карамель":
        "Тютюн із солодкою вершковою карамеллю: десертна м'якість поверх класичної тютюнової бази. Баланс солодкого й терпкого.",
    },
  },
];
