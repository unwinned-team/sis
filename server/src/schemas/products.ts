...
// price nullish: undefined/null = inherit (variant.price = NULL → наслідує
// product.price, єдина ціна на linearку). Override — лише коли число задано.
...
export const updateVariantSchema = z.object({
  ...
  size: z.string().nullable().optional(),
  description: z.string().nullable().optional(),
  // null = «скинути», наслідувати product.price; число = override.
  price: priceSchema.nullish(),
  isAvailable: z.boolean().optional(),
  imageUrl: z.string().nullable().optional(),
});
