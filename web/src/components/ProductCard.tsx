...
export function ProductCard({ product, showCategory = true }: ProductCardProps) {
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-2xl bg-[#1b1f3a] shadow-[0_10px_30px_rgb(27_31_58/0.12)] transition duration-200 md:hover:-translate-y-1 md:hover:shadow-[0_16px_40px_rgb(27_31_58/0.2)]">
